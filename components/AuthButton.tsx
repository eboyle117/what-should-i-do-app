...
export function AuthButton() {
  ...
  className="flex items-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-md hover:shadow-lg hover:scale-105 hover:bg-gray-50 transition-all duration-200 ease-in-out cursor-pointer"
>
